...
def parse_arguments(): 
    ...
    parser.add_argument('--parser', default="treesitter_rust",
    ...
    parser.add_argument('--train_path', default="treesitter_rust_train_test_val/treesitter_rust-buckets-train.pkl",
    ...
    parser.add_argument('--model_name', default="rust_classification")
